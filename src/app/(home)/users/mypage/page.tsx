  ...
  return (
    <div className="mt-10 max-w-5xl mx-auto px-4">
      ...
      <div className="flex gap-2 mt-2 text-lg">
        ...
        <div className="text-gray-700">{session?.user?.email || '이메일'}</div>
      </div>
      <div className="grid md:grid-cols-3 gap-4 mt-12 mb-20">
        ...
        >
          ...
          <div>
            ...
            <h1 className="text-sm text-gray-500">개인정보 및 연락처</h1>
          </div>
        </Link>
        <Link
          href="#"
        ...
        >
          ...
          <div>
            ...
            <h1 className="text-sm text-gray-500">나의 숙소 등록하기</h1>
          </div>
        </Link>
        <Link
          href="#"
        ...
        >
          ...
          <div>
            ...
            <h1 className="text-sm text-gray-500">나의 숙소 관리하기</h1>
          </div>
        </Link>
        <Link
          href="/users/likes"
        ...
        >
          ...
          <div>
            ...
            <h1 className="text-sm text-gray-500">찜한 숙소 모아보기</h1>
          </div>
        </Link>
        <Link
          href="/users/comments"
        ...
        >
          ...
          <div>
            ...
            <h1 className="text-sm text-gray-500">나의 댓글 모아보기</h1>
          </div>
        </Link>
        <Link
          href="/users/bookings"
        ...
        >
          ...
          <div>
            ...
            <h1 className="text-sm text-gray-500">나의 예약 모아보기</h1>
          </div>
        </Link>
      </div>
    </div>
